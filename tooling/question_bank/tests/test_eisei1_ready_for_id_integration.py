...
class Eisei1ReadyForIdIntegrationTests(unittest.TestCase):
    ...
    def test_integrated_inventory_is_contiguous_through_q179(self) -> None:
    ...
    def test_q1_q179_are_source_verified_and_pre_release(self) -> None:
