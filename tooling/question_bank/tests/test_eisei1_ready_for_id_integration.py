...
B11_EXPECTED = {
    "E1-B11-LH-C001": "EISEI1-Q-000020",
    "E1-B11-LH-C002": "EISEI1-Q-000021",
...
class Eisei1ReadyForIdIntegrationTests(unittest.TestCase):
    ...
    def test_integrated_inventory_is_contiguous_through_q23(self) -> None:
    ...
    def test_q1_q23_verified_and_pre_release(self) -> None:
    ...
    def test_b11_is_integrated_and_source_verified(self) -> None:
        batch = self.authoring / "batches" / "batch_011"
        candidates = read_rows(batch / "candidates.csv")
        self.assertEqual(set(B11_EXPECTED), set(candidates))
        self.assertEqual(set(B11_EXPECTED), {path.stem for path in (batch / "acceptance_packets").glob("*.json")})
