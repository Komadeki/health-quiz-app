...
B59_EXPECTED = {f"E1-B59-HG-C00{index}": f"EISEI1-Q-{194 + index:06d}" for index in range(1, 4)}
B60_EXPECTED = {f"E1-B60-PH-C00{index}": f"EISEI1-Q-{197 + index:06d}" for index in range(1, 4)}
B61_EXPECTED = {f"E1-B61-LG-C00{index}": f"EISEI1-Q-{200 + index:06d}" for index in range(1, 4)}
B62_EXPECTED = {f"E1-B62-HG-C00{index}": f"EISEI1-Q-{203 + index:06d}" for index in range(1, 4)}
B63_EXPECTED = {f"E1-B63-LH-C00{index}": f"EISEI1-Q-{206 + index:06d}" for index in range(1, 4)}
B64_EXPECTED = {f"E1-B64-HG-C00{index}": f"EISEI1-Q-{209 + index:06d}" for index in range(1, 4)}
B65_EXPECTED = {f"E1-B65-PH-C00{index}": f"EISEI1-Q-{212 + index:06d}" for index in range(1, 3)}
B66_EXPECTED = {f"E1-B66-LH-C00{index}": f"EISEI1-Q-{214 + index:06d}" for index in range(1, 4)}
B67_EXPECTED = {f"E1-B67-HH-C00{index}": f"EISEI1-Q-{217 + index:06d}" for index in range(1, 4)}
...
B72_EXPECTED = {f"E1-B72-LH-C00{index}": f"EISEI1-Q-{232 + index:06d}" for index in range(1, 4)}
B73_EXPECTED = {f"E1-B73-LH-C00{index}": f"EISEI1-Q-{235 + index:06d}" for index in range(1, 4)}
B74_EXPECTED = {f"E1-B74-LH-C00{index}": f"EISEI1-Q-{238 + index:06d}" for index in range(1, 4)}
B75_EXPECTED = {f"E1-B75-PH-C00{index}": f"EISEI1-Q-{241 + index:06d}" for index in range(1, 4)}
B76_EXPECTED = {f"E1-B76-LG-C00{index}": f"EISEI1-Q-{244 + index:06d}" for index in range(1, 4)}
B77_EXPECTED = {f"E1-B77-HH-C00{index}": f"EISEI1-Q-{247 + index:06d}" for index in range(1, 4)}
B78_EXPECTED = {f"E1-B78-LH-C00{index}": f"EISEI1-Q-{250 + index:06d}" for index in range(1, 3)}
...
B83_EXPECTED = {f"E1-B83-HG-C00{index}": f"EISEI1-Q-{264 + index:06d}" for index in range(1, 4)}
...
B88_EXPECTED = {f"E1-B88-HG-C00{index}": f"EISEI1-Q-{279 + index:06d}" for index in range(1, 4)}
B89_EXPECTED = {f"E1-B89-PH-C00{index}": f"EISEI1-Q-{282 + index:06d}" for index in range(1, 4)}
...
B98_EXPECTED = {f"E1-B98-LH-C00{index}": f"EISEI1-Q-{315 + index:06d}" for index in range(1, 6)}
B99_EXPECTED = {f"E1-B99-LG-C00{index}": f"EISEI1-Q-{320 + index:06d}" for index in range(1, 6)}
B100_EXPECTED = {f"E1-B100-HH-C00{index}": f"EISEI1-Q-{325 + index:06d}" for index in range(1, 6)}
B101_EXPECTED = {f"E1-B101-HH-C00{index}": f"EISEI1-Q-{330 + index:06d}" for index in range(1, 6)}
B102_EXPECTED = {f"E1-B102-PH-C00{index}": f"EISEI1-Q-{335 + index:06d}" for index in range(1, 6)}
B103_EXPECTED = {f"E1-B103-HG-C{index:03d}": f"EISEI1-Q-{340 + index:06d}" for index in range(1, 11)}
B104_EXPECTED = {f"E1-B104-LH-C{index:03d}": f"EISEI1-Q-{350 + index:06d}" for index in range(1, 11)}
...
EXPECTED_VERIFICATION_SOURCES = {
    ...
    "EISEI1-Q-000195": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000196": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000197": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000198": "E1-NHLBI-BLOOD-DONOR",
    "EISEI1-Q-000199": "E1-NHLBI-BLOOD-DONOR",
    "EISEI1-Q-000200": "E1-NHLBI-BLOOD-DONOR",
    "EISEI1-Q-000201": "E1-LAW-LSL",
    "EISEI1-Q-000202": "E1-LAW-LSL",
    "EISEI1-Q-000203": "E1-LAW-LSL",
    "EISEI1-Q-000204": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000205": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000206": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000207": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000208": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000209": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000210": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000211": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000212": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000213": "E1-NHLBI-HEART",
    "EISEI1-Q-000214": "E1-NHLBI-HEART",
    "EISEI1-Q-000215": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000216": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000217": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000218": "E1-MHLW-CHEMICAL-HAZARDS",
    "EISEI1-Q-000219": "E1-MHLW-CHEMICAL-HAZARDS",
    "EISEI1-Q-000220": "E1-MHLW-CHEMICAL-HAZARDS",
    "EISEI1-Q-000221": "E1-LAW-LSL",
    "EISEI1-Q-000222": "E1-LAW-LSL",
    "EISEI1-Q-000223": "E1-LAW-LSL",
    "EISEI1-Q-000224": "E1-LAW-LSL",
    "EISEI1-Q-000225": "E1-LAW-LSL",
    "EISEI1-Q-000226": "E1-LAW-LSL",
    ...
    "EISEI1-Q-000233": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000234": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000235": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000236": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000237": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000238": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000239": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000240": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000241": "E1-LAW-ASBESTOS",
    "EISEI1-Q-000242": "E1-NHLBI-HEART",
    "EISEI1-Q-000243": "E1-NHLBI-HEART",
    "EISEI1-Q-000244": "E1-NHLBI-HEART",
    "EISEI1-Q-000245": "E1-LAW-LSL",
    "EISEI1-Q-000246": "E1-LAW-LSL",
    "EISEI1-Q-000247": "E1-LAW-LSL",
    "EISEI1-Q-000248": "E1-MHLW-VIBRATION",
    "EISEI1-Q-000249": "E1-MHLW-VIBRATION",
    "EISEI1-Q-000250": "E1-MHLW-VIBRATION",
    "EISEI1-Q-000251": "E1-LAW-LEAD",
    "EISEI1-Q-000252": "E1-LAW-LEAD",
    "EISEI1-Q-000253": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000254": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000255": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000256": "E1-NIDDK-DIGESTIVE",
    "EISEI1-Q-000257": "E1-NIDDK-DIGESTIVE",
    "EISEI1-Q-000258": "E1-NIDDK-DIGESTIVE",
    ...
    "EISEI1-Q-000265": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000266": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000267": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000268": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000269": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000270": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000271": "E1-LAW-OXYGEN",
    "EISEI1-Q-000272": "E1-LAW-OXYGEN",
    "EISEI1-Q-000273": "E1-LAW-IONIZING",
    ...
    "EISEI1-Q-000280": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000281": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000282": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000283": "E1-NIDDK-KIDNEYS",
    "EISEI1-Q-000284": "E1-NIDDK-DIGESTIVE",
    "EISEI1-Q-000285": "E1-NIDDK-KIDNEYS",
    "EISEI1-Q-000286": "E1-LAW-IONIZING",
    "EISEI1-Q-000287": "E1-LAW-IONIZING",
    "EISEI1-Q-000288": "E1-LAW-DUST",
    "EISEI1-Q-000289": "E1-MHLW-CHEMICAL-HAZARDS",
    "EISEI1-Q-000290": "E1-MHLW-CHEMICAL-HAZARDS",
    "EISEI1-Q-000291": "E1-MHLW-CHEMICAL-HAZARDS",
    ...
    "EISEI1-Q-000298": "E1-NHLBI-HEART",
    "EISEI1-Q-000299": "E1-NHLBI-HEART",
    "EISEI1-Q-000300": "E1-NHLBI-HEART",
    "EISEI1-Q-000301": "E1-LAW-LEAD",
    "EISEI1-Q-000302": "E1-LAW-LEAD",
    "EISEI1-Q-000303": "E1-LAW-LEAD",
    "EISEI1-Q-000304": "E1-LAW-SPEC-CHEM",
    "EISEI1-Q-000305": "E1-LAW-SPEC-CHEM",
    "EISEI1-Q-000306": "E1-LAW-ASR",
    "EISEI1-Q-000307": "E1-LAW-ASR",
    "EISEI1-Q-000308": "E1-LAW-ASR",
    "EISEI1-Q-000309": "E1-LAW-ASR",
    "EISEI1-Q-000310": "E1-LAW-ASL",
    "EISEI1-Q-000311": "E1-NHLBI-BLOOD-DONOR",
    "EISEI1-Q-000312": "E1-NHLBI-BLOOD",
    "EISEI1-Q-000313": "E1-NHLBI-HEART",
    "EISEI1-Q-000314": "E1-NHLBI-HEART",
    "EISEI1-Q-000315": "E1-NHLBI-HEART",
    "EISEI1-Q-000316": "E1-LAW-LEAD",
    "EISEI1-Q-000317": "E1-LAW-LEAD",
    "EISEI1-Q-000318": "E1-LAW-LEAD",
    "EISEI1-Q-000319": "E1-LAW-LEAD",
    "EISEI1-Q-000320": "E1-LAW-LEAD",
    "EISEI1-Q-000321": "E1-LAW-LSL",
    "EISEI1-Q-000322": "E1-LAW-LSL",
    "EISEI1-Q-000323": "E1-LAW-LSL",
    "EISEI1-Q-000324": "E1-LAW-LSL",
    "EISEI1-Q-000325": "E1-LAW-LSL",
    "EISEI1-Q-000326": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000327": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000328": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000329": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000330": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000331": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000332": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000333": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000334": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000335": "E1-MHLW-RPE-2023",
    "EISEI1-Q-000336": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000337": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000338": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000339": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000340": "E1-NHLBI-LUNGS",
    "EISEI1-Q-000341": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000342": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000343": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000344": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000345": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000346": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000347": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000348": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000349": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000350": "E1-MHLW-INFO-EQUIPMENT",
    **{f"EISEI1-Q-{350 + index:06d}": "E1-LAW-LEAD" for index in range(1, 11)},
    ...
    **{f"EISEI1-Q-{373 + index:06d}": "E1-MHLW-BIOLOGICAL-MONITORING" for index in range(1, 4)},
    "EISEI1-Q-000377": "E1-MHLW-THREE-MANAGEMENT",
    "EISEI1-Q-000378": "E1-MHLW-THREE-MANAGEMENT",
    "EISEI1-Q-000379": "E1-MHLW-INFO-EQUIPMENT",
    "EISEI1-Q-000380": "E1-MHLW-THREE-MANAGEMENT",
    **{f"EISEI1-Q-{380 + index:06d}": "E1-LAW-LSL" for index in range(1, 7)},
    **{f"EISEI1-Q-{386 + index:06d}": "E1-MHLW-MENTAL-HEALTH-GUIDELINE" for index in range(1, 3)},
    **{f"EISEI1-Q-{388 + index:06d}": "E1-NIDDK-KIDNEYS" for index in range(1, 6)},
    "EISEI1-Q-000392": "E1-NIDDK-DIGESTIVE",
    "EISEI1-Q-000394": "E1-NCI-ERYTHROPOIETIN",
    "EISEI1-Q-000395": "E1-NIH-ODS-VITAMIN-D",
...
class Eisei1ReadyForIdIntegrationTests(unittest.TestCase):
    ...
    def test_integrated_batches_bind_exactly_to_canonical_rows(self) -> None:
        ...
        for batch_name, mapping in (
            ...
            ("batch_059", B59_EXPECTED),
            ("batch_060", B60_EXPECTED),
            ("batch_061", B61_EXPECTED),
            ("batch_062", B62_EXPECTED),
            ("batch_063", B63_EXPECTED),
            ("batch_064", B64_EXPECTED),
            ("batch_065", B65_EXPECTED),
            ("batch_066", B66_EXPECTED),
            ("batch_067", B67_EXPECTED),
            ("batch_068", B68_EXPECTED),
            ("batch_069", B69_EXPECTED),
            ("batch_070", B70_EXPECTED),
            ("batch_071", B71_EXPECTED),
            ("batch_072", B72_EXPECTED),
            ("batch_073", B73_EXPECTED),
            ("batch_074", B74_EXPECTED),
            ("batch_075", B75_EXPECTED),
            ("batch_076", B76_EXPECTED),
            ("batch_077", B77_EXPECTED),
            ("batch_078", B78_EXPECTED),
            ("batch_079", B79_EXPECTED),
            ("batch_080", B80_EXPECTED),
            ("batch_081", B81_EXPECTED),
            ("batch_082", B82_EXPECTED),
            ("batch_083", B83_EXPECTED),
            ("batch_084", B84_EXPECTED),
            ("batch_085", B85_EXPECTED),
            ("batch_086", B86_EXPECTED),
            ("batch_087", B87_EXPECTED),
            ("batch_088", B88_EXPECTED),
            ("batch_089", B89_EXPECTED),
            ...
            ("batch_098", B98_EXPECTED),
            ("batch_099", B99_EXPECTED),
            ("batch_100", B100_EXPECTED),
            ("batch_101", B101_EXPECTED),
            ("batch_102", B102_EXPECTED),
            ("batch_103", B103_EXPECTED),
            ("batch_104", B104_EXPECTED),
