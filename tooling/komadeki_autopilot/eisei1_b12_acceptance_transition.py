...
BATCH=REPO/"question_banks/eisei1/authoring/batches/batch_012"; STATE=REPO/"tooling/komadeki_autopilot/eisei1_state.json"
IDS=("E1-B12-LH-C001","E1-B12-LH-C002","E1-B12-LH-C003","E1-B12-LH-C004")
st=json.loads(STATE.read_text(encoding="utf-8"))
if st.get("state_epoch")!=17 or st.get("next_atomic_objective")!="ACCEPT_EISEI1_B12_CANDIDATES_4": raise SystemExit("unexpected state")
...
st.update(observed_main=subprocess.check_output(["git","rev-parse","HEAD"],text=True).strip(),next_atomic_objective="ALLOCATE_AND_INTEGRATE_EISEI1_B12_ACCEPTED_4",state_epoch=18); STATE.write_text(json.dumps(st,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
